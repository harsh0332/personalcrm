-- CALLDESK COMPLETE DB SCHEMA MIGRATION
...
CREATE TABLE IF NOT EXISTS public.leads (
    ...
    campaign TEXT DEFAULT 'Indore Dentists',
...
DROP POLICY IF EXISTS "Allow public read access to dispositions" ON public.dispositions;
...
DROP POLICY IF EXISTS "Users can manage own imports" ON public.imports;
